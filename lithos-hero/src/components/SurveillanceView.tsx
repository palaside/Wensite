              ...
              <div className="bg-slate-950 border border-slate-800 rounded-xl p-6 shadow-inner flex flex-col items-center justify-center min-h-[300px]">
                {targetGrid ? (
                  <div className="text-center animate-in zoom-in duration-300 w-full">
                    ...
                    <MapView 
                      isVisible={true}
                      targetGrid={formatGrid8(targetGrid)}
                      customPositionClass="relative w-full h-[250px] mt-6 rounded-xl border border-slate-700 overflow-hidden shadow-inner"
                    />
                    
                    <div className="mt-6 flex flex-col md:flex-row gap-3 items-center w-full justify-center">
                      <button 
                        onClick={() => {
                          if (onRequestFire) {
